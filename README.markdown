# Official PayPal Express for Spree 0.70.X

This is a modified version of the official Spree Paypal Express that will:

* Work with Spree 0.70.X
* Send ecommerce data to Google Analytics

Versions
========

The master branch of this repo is currently for Spree 0.70.3 and later
